...
export function TitleBar() 
{
    return (
        <div className="flex justify-between items center ">
            ...
            <div className="flex justify-between items center space-x-2 items-center pl-2">
                <h4> Payouts </h4> 
             ...
             <div className="flex space-x-2 items-center w-[270px] h-[43px]"> 
                <div className=" flex space-x-2 items-center w-[270px] h-[32px] box-border bg-gray-200 rounded"> 
                    ...
                    <input type="search"  placeholder="Search Mockups, Logos..." className="bg-gray-200" required></input>
                </div>
             </div>

            <div className="flex space-x-2 pr-10 items-center"> 
